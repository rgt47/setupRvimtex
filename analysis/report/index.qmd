...
categories: [vim, r, latex, neovim, configuration]
  [Vim, R Programming, LaTeX, Developer Tools]
description: >
...
![A quiet workspace with monitors and reference
materials spread across a desk.
](media/images/ambiance1.jpg){.img-fluid
fig-alt="An atmospheric photograph of a developer
workspace with multiple monitors and books."}
